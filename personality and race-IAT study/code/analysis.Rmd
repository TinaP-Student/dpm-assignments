...
### BFI Plots
alle Plots haben die gleichen Dimensionen, falls man sie verglecihen will, wird das so einfacher sein
...
Ich habe alle Facetten ein hgeading gegeben, wenn man den Code rennt, dass man die Sachen dann beiannder hat und summary ebenfalls gemacht, weil ich das hilfreich fand
ausserdem habe ich auch Regressionen für mean1 und mean2 gemacht, weil ich die aufgabe zuerst falsch verstanden habe und anstatt sie zu löschen, habe ich sie in hashtags gesetzt - man weiss nie, wann was doch nützlich sein könnte
...
ggsave("../communications/plot_comb_bfi.png", plot = plot_comb_bfi,  width = 16, height = 8, dpi = 300, device = "png")

ggsave("../communications/plot_comb_bfi.pdf", plot = plot_comb_bfi,width = 16, height = 8, device = "pdf")
