...
#ich habe zwei Versionen gemacht, weil es nicht genau in der Aufgabe stand
#in der zweiten Version habe ich alle NAs gedroppt und es hat einen gigantischen Unterschied gemacht
...
# ultimative join - again with the two diffrent versions
...
# duplicates... no duplicates, but not anymore 179 Participants -> 182 the extra two are from the demographics and they don't have any Scale Datas - ich werde sie ihm nächsten Schritt droppen
...
Ich werde eine weitere Variable kreaieren, die die Teilnehmer ohne ScaleDaten ebenfalls herausnimmt, weil die aus dem Datasatz Demographics kommen 
```{r}
